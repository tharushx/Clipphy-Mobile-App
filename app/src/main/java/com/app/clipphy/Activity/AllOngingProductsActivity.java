...
public class AllOngingProductsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Window window=AllOngingProductsActivity.this.getWindow();
        window.setStatusBarColor(ContextCompat.getColor(AllOngingProductsActivity.this,R.color.main_color));

        // Ensure RecyclerView is properly initialized
        allRecycle = findViewById(R.id.allRecycle);
        if (allRecycle != null) {
            initRecycleView();
            loadProducts();
        }
    ...
    private void initRecycleView() {
        allRecycle.setLayoutManager(new GridLayoutManager(this, 2));
        productsArrayList = new ArrayList<>();
        allProductAdapter = new AllProductAdapter(this, productsArrayList);
        allRecycle.setAdapter(allProductAdapter);
    }
