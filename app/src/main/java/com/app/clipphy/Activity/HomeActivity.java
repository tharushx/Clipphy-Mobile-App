...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        window.setStatusBarColor(ContextCompat.getColor(HomeActivity.this,R.color.main_color));
        ...
        ongoingViewAll.setOnClickListener(v -> {
            Intent intent2 = new Intent(HomeActivity.this, AllOngingProductsActivity.class);
            startActivity(intent2);
        });

        TextView allProductstxt = findViewById(R.id.allProductstxt);
        allProductstxt.setOnClickListener(v -> {
            Intent intent2 = new Intent(HomeActivity.this, AllProductsActivity.class);
            startActivity(intent2);
        });
